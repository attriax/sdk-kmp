...
/**
 * Native mirror of the JVM `AttriaxDesktopStoreLayoutTest`: the #78 two-file store
 * layout over a real dataDir — different project tokens share the device id (#72)
 * but never mutable state, and a legacy single-file store carries forward on
 * upgrade. (Unique timestamped temp dirs; stale files cannot collide across runs,
 * matching the existing native store test's cleanup stance.)
 */
class AttriaxDesktopNativeStoreLayoutTest {

    private lateinit var dataDir: String

    @BeforeTest
    fun setup() {
        dataDir = uniqueTempDir("layout")
    }

    @Test
    fun differentProjectTokensIsolateMutableStateButShareTheDeviceId() {
        val storeA = AttriaxDesktopNative.createProjectScopedStore(dataDir, "tok_a", "com.app.a")
        ...
        val storeB = AttriaxDesktopNative.createProjectScopedStore(dataDir, "tok_b", "com.app.b")
        ...
        val reopenedA = AttriaxDesktopNative.createProjectScopedStore(dataDir, "tok_a", "com.app.a")
    ...
    fun legacySingleFileStateCarriesForwardOnUpgrade() {
        ...
        val legacy = AttriaxNativeFileKeyValueStore(dataDir)
        ...
        val upgraded = AttriaxDesktopNative.createProjectScopedStore(dataDir, "tok_a", "com.app.a")
        ...
        val legacyReopened = AttriaxNativeFileKeyValueStore(dataDir)
        ...
        val other = AttriaxDesktopNative.createProjectScopedStore(dataDir, "tok_b", "com.app.b")
